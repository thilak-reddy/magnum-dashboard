...
export const monthlyCheckResults = [
  // M05 Gross
  { id: 'mc01', moduleCode: 'M05', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Earned gross',     expected: '₹12,557',  actual: '₹12,557', variance: 0,     message: 'Earned gross matches calculation', severity: 'HIGH'   },
  { id: 'mc02', moduleCode: 'M05', employeeId: 'e04', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Earned gross',     expected: '₹14,760',  actual: '₹14,760', variance: 0,     message: 'Earned gross matches calculation', severity: 'HIGH'   },
  { id: 'mc03', moduleCode: 'M05', employeeId: 'e06', factoryId: 'f1', monthYear: '2026-02', status: 'FAIL', checkName: 'Earned gross',     expected: '₹9,108',   actual: '₹9,416',  variance: 308,   message: 'Earned gross does not match — LOP days discrepancy (5 vs 6 LOP days)', severity: 'HIGH' },
  // M06 Min Wage
  { id: 'mc04', moduleCode: 'M06', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Min wage compliance', expected: '≥ ₹10,000', actual: '₹10,000', variance: 0, message: 'Basic+DA meets minimum wage', severity: 'CRITICAL' },
  { id: 'mc05', moduleCode: 'M06', employeeId: 'e12', factoryId: 'f1', monthYear: '2026-02', status: 'FAIL', checkName: 'Min wage compliance', expected: '≥ ₹8,650', actual: '₹8,650', variance: 0, message: 'PASS — basic+DA meets minimum', severity: 'CRITICAL' },
  // M07 Attendance Bonus
  { id: 'mc06', moduleCode: 'M07', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Attendance bonus', expected: '₹500',    actual: '₹500',   variance: 0,     message: 'Attendance bonus correct — eligible (0 absent, 0 late)', severity: 'HIGH'   },
  { id: 'mc07', moduleCode: 'M07', employeeId: 'e06', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Attendance bonus', expected: '₹0',      actual: '₹0',     variance: 0,     message: 'Not eligible — 6 absent days. Bonus correctly ₹0', severity: 'HIGH'   },
  { id: 'mc08', moduleCode: 'M07', employeeId: 'e10', factoryId: 'f1', monthYear: '2026-02', status: 'FAIL', checkName: 'Attendance bonus', expected: '₹0',      actual: '₹300',   variance: -300,  message: 'Meenakshi Sundaram is an Ironer — finishing incentive, NOT attendance bonus', severity: 'HIGH' },
  // M08 Incentive
  { id: 'mc09', moduleCode: 'M08', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Worker incentive', expected: '₹1,620',  actual: '₹1,620', variance: 0,     message: 'Incentive at 17% (88.5% efficiency) correct', severity: 'HIGH'   },
  { id: 'mc10', moduleCode: 'M08', employeeId: 'e07', factoryId: 'f1', monthYear: '2026-02', status: 'FAIL', checkName: 'Worker incentive', expected: '₹0',      actual: '₹1,700', variance: -1700, message: 'Quality Checker not in production line — incorrect incentive applied', severity: 'HIGH' },
  // M09 OT
  { id: 'mc11', moduleCode: 'M09', employeeId: 'e04', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Worker OT',        expected: '₹1,056',  actual: '₹1,056', variance: 0,     message: 'OT rate (8200÷26÷8×2) × 12hrs correct', severity: 'HIGH'   },
  { id: 'mc12', moduleCode: 'M09', employeeId: 'e09', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Staff OT',         expected: '₹1,050',  actual: '₹1,050', variance: 0,     message: '3 qualifying OT days × ₹350 correct', severity: 'HIGH'   },
  // M10 EPF
  { id: 'mc13', moduleCode: 'M10', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'FAIL', checkName: 'EPF deduction',    expected: '₹1,454',  actual: '₹1,460', variance: -6,    message: 'EPF over-deducted by ₹6 — rounding difference in earned base', severity: 'HIGH' },
  { id: 'mc14', moduleCode: 'M10', employeeId: 'e04', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'EPF capped at ₹1,800', expected: '₹1,800', actual: '₹1,800', variance: 0, message: 'EPF base >₹15k — correctly capped at ₹1,800', severity: 'HIGH' },
  // M11 ESI
  { id: 'mc15', moduleCode: 'M11', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'ESI deduction',    expected: '₹119',    actual: '₹119',   variance: 0,     message: '0.75% of ₹15,880 (incl. OT) correct', severity: 'HIGH'   },
  { id: 'mc16', moduleCode: 'M11', employeeId: 'e07', factoryId: 'f1', monthYear: '2026-02', status: 'FAIL', checkName: 'ESI not deducted', expected: 'ESI ₹111', actual: '₹111',   variance: 0,     message: 'ESI correct', severity: 'HIGH'   },
  // M12 PT
  { id: 'mc17', moduleCode: 'M12', employeeId: 'e02', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Professional Tax', expected: '₹135',    actual: '₹135',   variance: 0,     message: 'PT slab ₹21k–₹30k = ₹135 correct', severity: 'MEDIUM'  },
  // M13 TDS
  { id: 'mc18', moduleCode: 'M13', employeeId: 'e03', factoryId: 'f1', monthYear: '2026-02', status: 'WARN', checkName: 'TDS check',        expected: 'Review annual', actual: '₹0', variance: null, message: 'Priya K annual projection ~₹4.1L — no TDS needed. Within ₹12L limit.', severity: 'MEDIUM' },
  // M14 Loan
  { id: 'mc19', moduleCode: 'M14', employeeId: 'e04', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Loan EMI',         expected: '₹1,500',  actual: '₹1,500', variance: 0,     message: 'Loan EMI correctly deducted — 8 of 12 installments paid', severity: 'HIGH'   },
  // M15 Advance
  { id: 'mc20', moduleCode: 'M15', employeeId: 'e05', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Salary advance',   expected: '₹2,000',  actual: '₹2,000', variance: 0,     message: 'Advance from Feb correctly deducted in Feb', severity: 'HIGH'   },
  // M16 Late deduction
  { id: 'mc21', moduleCode: 'M16', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Late deduction',   expected: '₹0',      actual: '₹0',     variance: 0,     message: 'No late instances — no deduction', severity: 'MEDIUM'  },
  // M17 LOP
  { id: 'mc22', moduleCode: 'M17', employeeId: 'e06', factoryId: 'f1', monthYear: '2026-02', status: 'FAIL', checkName: 'LOP match',        expected: '5 LOP days', actual: '6 LOP days in payroll', variance: null, message: 'LOP mismatch — attendance shows 5 days, payroll used 6 days', severity: 'HIGH' },
  // M18 50% cap
  { id: 'mc23', moduleCode: 'M18', employeeId: 'e04', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: '50% deduction cap', expected: '≤₹7,083', actual: '₹1,935', variance: null, message: 'Total deductions well within 50% cap', severity: 'CRITICAL' },
  // M19-M23 Others
  { id: 'mc24', moduleCode: 'M19', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'CPF adjustment',   expected: '₹0',      actual: '₹0',     variance: 0,     message: 'No CPF carry-forward drift', severity: 'LOW'     },
  { id: 'mc25', moduleCode: 'M20', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Holiday pay',      expected: 'P on holidays', actual: '2 holidays marked P', variance: null, message: 'Republic Day and Pongal marked Present correctly', severity: 'MEDIUM' },
  { id: 'mc26', moduleCode: 'M21', employeeId: 'e06', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Layoff pay',       expected: 'No layoff', actual: 'No layoff', variance: null, message: 'No layoff recorded — OK', severity: 'MEDIUM' },
  { id: 'mc27', moduleCode: 'M22', employeeId: 'e09', factoryId: 'f1', monthYear: '2026-02', status: 'PASS', checkName: 'Comp-off',         expected: 'Compoff not in OT', actual: 'Compoff isolated', variance: null, message: '3.5 compoff hrs not flowing into OT — correct', severity: 'HIGH' },
  { id: 'mc28', moduleCode: 'M23', employeeId: 'e01', factoryId: 'f1', monthYear: '2026-02', status: 'FAIL', checkName: 'Net pay',          expected: '₹13,422', actual: '₹13,416', variance: -6,    message: 'Net pay off by ₹6 — trace to EPF rounding (M10)', severity: 'CRITICAL' },
